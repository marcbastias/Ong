...
<style>
    ...
    .option {
        ...
        color: white;
        cursor: pointer;
        border: 2px solid transparent; /* Añadir borde transparente */
        border-radius: 8px;
        margin-right: 10px;
    }
    ...
    .option.selected {
        border-color: white; /* Cambiar el color del borde al blanco */
        background-image: url('../assets/images/huella.png'); /* Agregar la imagen de la huella */
        background-repeat: no-repeat; /* Evitar que se repita la imagen */
        background-position: right center; /* Posicionar la imagen a la derecha del botón */
        padding-right: 30px; /* Ajustar el espacio para la imagen */
    }
</style>
</head>
<body>
...
<div class="mt-80 flex justify-center items-center h-full">
    <div class="p-8 bg-[#A7DD7D] shadow-md" style="width: 800px;">
        ...
        <div class="gap-28 p-5 mb-8 flex justify-center">
            <div>
                <input type="radio" id="socio_adulto" name="tipo_socio" value="socio_adulto" class="mr-2 hidden" onclick="handleButtonClick(this)">
                <label for="socio_adulto" class="option">Socio Adulto</label>
            </div>
            <div>
                <input type="radio" id="socio_menos" name="tipo_socio" value="socio_menos" class="ml-2 hidden" onclick="handleButtonClick(this)">
        ...
        <div class="mb-8 flex justify-center gap-20">
            <input type="radio" id="mensual" name="tipo_suscripcion" value="mensual" class="mr-2 hidden" onclick="handleButtonClick(this)">
            <label for="mensual" class="option">Mensual</label>
            <input type="radio" id="trimestral" name="tipo_suscripcion" value="trimestral" class="mr-2 hidden" onclick="handleButtonClick(this)">
            <label for="trimestral" class="option">Trimestral</label>
            <input type="radio" id="anual" name="tipo_suscripcion" value="anual" class="ml-2 hidden" onclick="handleButtonClick(this)">
            <label for="anual" class="option">Anual</label>
        </div>

        <label for="cantidad" class="text-white block mb-2">Cantidad:</label>
        <input type="number" id="cantidad" name="cantidad" placeholder="Ingrese la cantidad" class="w-full border border-gray-300 px-4 py-2 mb-8">
        <hr class="my-8">
        <div class="mb-8 flex justify-center gap-28 p-4">
            <input type="radio" id="formato_digital" name="formato" value="digital" class="mr-2 hidden" onclick="handleButtonClick(this)">
            <label for="formato_digital" class="option">Formato Digital</label>
            <input type="radio" id="formato_papel" name="formato" value="papel" class="ml-2 hidden" onclick="handleButtonClick(this)">
        ...
        <input type="email" id="correo" name="correo" placeholder="Ingrese su correo electrónico" class="w-full border border-gray-300 px-4 py-2 mb-8">
