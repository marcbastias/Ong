<h1 class="contact-form_title">Otras consultas</h1>
<h5 class="contact-form_subtitle">
    Envíanos tu consulta rellenando este formulario y nos pondremos en contacto contigo con la mayor brevedad posible. Si no puedes esperar, por favor, llámanos al teléfono (+34) 91 354 0578 en horario de lunes a jueves de 8 a 17.30h y los viernes de 8 a 14h.
</h5>

<form action="{{ route('contacto.otherQueries') }}" method="post" enctype="multipart/form-data" class="p-11 grid grid-cols-2 gap-4">
    @csrf
    ...
    <div class="form-group col-span-1">
        <label for="phone">¿Quieres que te llamemos? Déjanos un teléfono de contacto</label>
